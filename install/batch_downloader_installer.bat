...
:: 下载并执行脚本
%PS% %PS_ARGS% -Command "IEX (Invoke-WebRequest -Uri 'https://github.com/Aermberry/BatchDownloader/raw/refs/heads/main/insatll/aria2_project_builder.ps1' -UseBasicParsing).Content"
